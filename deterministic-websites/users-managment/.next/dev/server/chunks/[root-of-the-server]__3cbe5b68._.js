...
"[project]/app/api/track/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    try {
        ...
        const baseUrl = process.env.VERCEL_PROJECT_PRODUCTION_URL ? `https://${process.env.VERCEL_PROJECT_PRODUCTION_URL}` : url.origin;
        const payload = {
            base_url: baseUrl,
            event_type: event,
            event_data: data,
        ...
        const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].from('events').insert(payload);
        if (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__3cbe5b68._.js.map